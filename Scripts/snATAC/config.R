...
main_f <- '/work/Neuroinformatics_Core/s204365/snATAC/'        #Please set this to the main path where you wish to perform the analysis
library(pals)
### Global Directories ###
rna_sample_dir <- '..........'             # the files from the 10x scRNA run should be located here
atac_sample_dir <- '.........'           # the files from the 10x scATAC run should be located here
sample_names <- c('104_ctl','105_p1_cko', '106_p2_cko', '107_p1p2_cko')
